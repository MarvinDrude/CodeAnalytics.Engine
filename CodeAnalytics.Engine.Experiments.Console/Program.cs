...
var collector = new ProjectCollector(new ProjectOptions()
{
   ...
   ProjectPath = @"C:\Users\marvi\source\repos\CodeAnalytics.Engine\CodeAnalytics.Engine.TestContainer.SimpleOne\CodeAnalytics.Engine.TestContainer.SimpleOne.csproj",
